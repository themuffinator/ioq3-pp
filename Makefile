...
ifndef CLIENTBIN
CLIENTBIN=ioquake3-pp
endif

ifndef SERVERBIN
SERVERBIN=ioq3ded-pp
endif
...
ifndef USE_RENDERER_GLSLFBO
USE_RENDERER_GLSLFBO=1
endif
...
JPDIR=$(LIB_DIR)/jpeg-8c
SPEEXDIR=$(LIB_DIR)/libspeex
ZDIR=$(LIB_DIR)/zlib
Q3ASMDIR=$(LIB_DIR)/tools/asm
LBURGDIR=$(LIB_DIR)/tools/lcc/lburg
Q3CPPDIR=$(LIB_DIR)/tools/lcc/cpp
Q3LCCETCDIR=$(LIB_DIR)/tools/lcc/etc
Q3LCCSRCDIR=$(LIB_DIR)/tools/lcc/src
LOKISETUPDIR=misc/setup
NSISDIR=misc/nsis
SDLHDIR=$(LIB_DIR)/SDL12
LIBSDIR=$(LIB_DIR)
...
ifeq ($(USE_RENDERER_GLSLFBO),1)
  CLIENT_CFLAGS += -DUSE_RENDERER_GLSLFBO
endif
...
Q3RSTRINGOBJ = \
  $(B)/renderer/glsl/blurhoriz.o \
  $(B)/renderer/glsl/blurvertical.o \
  $(B)/renderer/glsl/brightpass.o \
  $(B)/renderer/glsl/colorcorrect.o \
  $(B)/renderer/glsl/combine.o \
  $(B)/renderer/glsl/downsample1.o \
  $(B)/renderer/glsl/posteffect.o \
...
$(B)/renderer_opengl1_$(SHLIBNAME): $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3POBJ)
	$(echo_cmd) "LD $@"
	$(Q)$(CC) $(CFLAGS) $(SHLIBLDFLAGS) -o $@ $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3POBJ) \
		$(THREAD_LIBS) $(LIBSDLMAIN) $(RENDERER_LIBS) $(LIBS)

$(B)/renderer_opengl1_smp_$(SHLIBNAME): $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3POBJ_SMP)
	$(echo_cmd) "LD $@"
	$(Q)$(CC) $(CFLAGS) $(SHLIBLDFLAGS) -o $@ $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3POBJ_SMP) \
		$(THREAD_LIBS) $(LIBSDLMAIN) $(RENDERER_LIBS) $(LIBS)
else
$(B)/$(CLIENTBIN)$(FULLBINEXT): $(Q3OBJ) $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3POBJ) $(LIBSDLMAIN)
	$(echo_cmd) "LD $@"
	$(Q)$(CC) $(CLIENT_CFLAGS) $(CFLAGS) $(CLIENT_LDFLAGS) $(LDFLAGS) \
		-o $@ $(Q3OBJ) $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3POBJ) \
		$(LIBSDLMAIN) $(CLIENT_LIBS) $(RENDERER_LIBS) $(LIBS)

$(B)/$(CLIENTBIN)-smp$(FULLBINEXT): $(Q3OBJ) $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3POBJ_SMP) $(LIBSDLMAIN)
	$(echo_cmd) "LD $@"
	$(Q)$(CC) $(CLIENT_CFLAGS) $(CFLAGS) $(CLIENT_LDFLAGS) $(LDFLAGS) $(THREAD_LDFLAGS) \
		-o $@ $(Q3OBJ) $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3POBJ_SMP) \
...
$(B)/renderer/glsl/%.c: $(RDIR)/glsl/%.vs
	$(DO_REF_STR)

$(B)/renderer/glsl/%.c: $(RDIR)/glsl/%.fs
	$(DO_REF_STR)
	
$(B)/renderer/glsl/%.o: $(RDIR)/glsl/%.c
	$(DO_REF_CC)
...
OBJ = $(Q3OBJ) $(Q3POBJ) $(Q3POBJ_SMP) $(Q3ROBJ) $(Q3RSTRINGOBJ) $(Q3DOBJ) \
