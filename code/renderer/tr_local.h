...
typedef struct {
	...
	GLuint		bloomTexture;				//-->tr_image.c
	GLuint		backBufferTexture;			//-->tr_image.c
	int			drawSurfsCount;				//-->tr_backend.c

	GLuint		frameBuffer;				//backend, fbo, glsl
	GLuint		frameBufferMultiSample;		//backend, fbo, glsl
	GLuint		renderBufferMultiSample;	//backend, fbo
	GLuint		sceneTexture;				//backend, fbo, glsl
	GLuint		depthTexture;
	GLuint		depthBuffer;
	GLuint		depthBufferMultiSample;

	qboolean	usingFrameBufferObject;		//backend, cmds, fbo, shadows
	qboolean	usingMultiSample;			//backend, fbo, glsl
	qboolean	usingFboStencil;			//backend, fbo, glsl, shadows
...
//muff
// tr_arc.c
void RE_ScaleCorrection( float *x, float *y, float *w, float *h, char *shaderName );
//-muff
...
extern cvar_t *r_enableFbo;
extern cvar_t *r_fboAntiAlias;
#endif //USE_RENDERER_GLSLFBO

//glclamp
extern	cvar_t	*r_glClampToEdge;
//-glclamp
