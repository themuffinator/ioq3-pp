...
{
	void (*Shutdown)(void);
	void (*StartSound)( vec3_t origin, int entnum, int entchannel, sfxHandle_t sfx, const qboolean cgame );
	void (*StartLocalSound)( sfxHandle_t sfx, int channelNum, const qboolean cgame );
	void (*StartBackgroundTrack)( const char *intro, const char *loop, const qboolean cgame );
...
extern	cvar_t	*s_menuMusicVolume;
//-muff
