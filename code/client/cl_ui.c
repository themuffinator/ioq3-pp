...
intptr_t CL_UISystemCalls( intptr_t *args ) {
	...
	case UI_R_DRAWSTRETCHPIC:
		...
		re.DrawStretchAspectPic( VMF(1), VMF(2), VMF(3), VMF(4), VMF(5), VMF(6), VMF(7), VMF(8), args[9], qfalse );
		return 0;
  ...
  case UI_R_MODELBOUNDS:
	...
	case UI_S_STARTLOCALSOUND:
		S_StartLocalSound( args[1], args[2], qfalse );
		return 0;
	...
	case UI_S_STARTBACKGROUNDTRACK:
		S_StartBackgroundTrack( VMA(1), VMA(2), qfalse );
		return 0;
