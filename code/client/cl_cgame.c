...
// ZOID
	...
	case CG_S_STARTSOUND:
		S_StartSound( VMA(1), args[2], args[3], args[4], qtrue );
		return 0;
	case CG_S_STARTLOCALSOUND:
		S_StartLocalSound( args[1], args[2], qtrue );
		return 0;
	...
	case CG_S_STARTBACKGROUNDTRACK:
		S_StartBackgroundTrack( VMA(1), VMA(2), qtrue );
		return 0;
	...
	case CG_R_DRAWSTRETCHPIC:
		...
		re.DrawStretchAspectPic( VMF(1), VMF(2), VMF(3), VMF(4), VMF(5), VMF(6), VMF(7), VMF(8), args[9], qtrue );
		return 0;
...
void CL_InitCGame( void ) {
	...
	Com_VPrintf( "CL_InitCGame: %5.2f seconds\n", (t2-t1)/1000.0 );
