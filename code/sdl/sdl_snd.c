...
qboolean SNDDMA_Init(void)
{
	...
	Com_VPrintf( "SDL_Init( SDL_INIT_AUDIO )... SUCCESS" );	//Com_VPrintf

	if (SDL_AudioDriverName(drivername, sizeof (drivername)) == NULL)
		strcpy(drivername, "(UNKNOWN)");
	Com_VPrintf("SDL audio driver is \"%s\".\n", drivername);	//Com_VPrintf
	...
	Com_VPrintf( "Starting SDL audio callback...\n" );	//Com_VPrintf
	SDL_PauseAudio(0);  // start callback.

	Com_VPrintf( "SDL audio initialized.\n" );	//Com_VPrintf
	snd_inited = qtrue;
	return qtrue;
}
