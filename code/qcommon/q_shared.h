...
#else
  #define PRODUCT_NAME			"ioq3-pp"
  #define BASEGAME			"baseq3"
  #define CLIENT_WINDOW_TITLE     	"ioquake3-pp"
  #define CLIENT_WINDOW_MIN_TITLE 	"ioq3-pp"
...
extern	vec4_t		colorBlu2;	//**
extern	vec4_t		colorRd2;	//**

extern	vec4_t		colorCoal;
...
//#define COLOR_BITS  79
//#define ColorIndex(c)	( (((c) - '0') &15) %(COLOR_BITS+1) )
...
extern vec4_t	g_color_table[80];
...
//muff
void COM_ForcePath( char *base, int maxSize, char *path );
//-muff
