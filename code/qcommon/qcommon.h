...
extern qboolean alias_modified;
...
#ifdef DEDICATED
#define CFGPATH "cfg-sv/"
#define Q3CONFIG_CFG "q3config_server.cfg"
#define DEFCONFIG_CFG "config.cfg"
...
//muff
// verbose printing
void 		QDECL Com_VPrintf( const char *fmt, ... ) __attribute__ ((format (printf, 1, 2)));
//-muff
